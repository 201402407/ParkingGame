...
void Bus::wallRight() {// RIGHT
	glEnable(GL_TEXTURE_2D);

	glPushMatrix();
	glRotatef(180, 0.0, 1.0, 0.0);
	glScalef(4.0, 4.0, 4.0);
	glBindTexture(GL_TEXTURE_2D, texWall); // RIGHT
	glBegin(GL_QUADS);
	glTexCoord2f(1.0, 0.0); glVertex3f(-45, -80, 100);
	glTexCoord2f(1.0, 1.0); glVertex3f(-45, 80, 100);
	glTexCoord2f(0.0, 1.0); glVertex3f(-45, 80, -100);
...
void Bus::wallLeft() {
	...
	//glScalef(3.0, 1.0, 3.0);
	glScalef(4.0, 4.0, 4.0);
	glBindTexture(GL_TEXTURE_2D, texWall); // LEFT
	glBegin(GL_QUADS);
	glTexCoord2f(0.0, 1.0); glVertex3f(-45, 80, -100);
	glTexCoord2f(0.0, 0.0); glVertex3f(-45, -80, -100);
	glTexCoord2f(1.0, 0.0); glVertex3f(-45, -80, 100);
...
void Bus::wallBack() {
	...
	glEnable(GL_TEXTURE_2D);
	glScalef(4.0, 4.0, 4.0);
	glBindTexture(GL_TEXTURE_2D, texWall); // BACK
	glBegin(GL_QUADS);
	glTexCoord2f(0.0, 0.0); glVertex3f(-45, -80, 100);
	glTexCoord2f(1.0, 0.0); glVertex3f(45, -80, 100);
	glTexCoord2f(0.0, 1.0); glVertex3f(45, 80, 100);
...
void Bus::wallFront() {
	...
	glEnable(GL_TEXTURE_2D);
	glScalef(4.0, 4.0, 4.0);
	glBindTexture(GL_TEXTURE_2D, texWall); // FRONT
	glBegin(GL_QUADS);
	glTexCoord2f(-1.0, 0.96); glVertex3f(-45, 80, -100);
	glTexCoord2f(0.0, 0.96); glVertex3f(45, 80, -100);
	glTexCoord2f(1.0, 0.0); glVertex3f(45, -80, -100);
...
void Bus::wallBottom() {
	...
	//glScalef(1.5, 0.1, 0.85);
	glScalef(4.0, 4.0, 4.0);
	glBindTexture(GL_TEXTURE_2D, texWall); // BOTTOM
	glBegin(GL_QUADS);
	glTexCoord2f(0.0, 1.0); glVertex3f(-45, -80, -100);
	glTexCoord2f(1.0, 1.0); glVertex3f(45, -80, -100);
	glTexCoord2f(1.0, 0.0); glVertex3f(45, -80, 100);
